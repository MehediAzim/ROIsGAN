...
from roisgan.utils import paired_dataset_length
...
def main():
    ...
    # Dataset and Loaders
    indices = list(range(paired_dataset_length(CONFIG['image_dir'], CONFIG['mask_dir'])))
    ...
    logging.info(f"| ROIsGAN  | {metrics[0]:.2f} ± {metrics[1]:.2f} | {metrics[2]:.2f} ± {metrics[3]:.2f} | "
